...
class MyMaskProfilePhotoCamera extends StatefulWidget {
  final Function(File?) onImageCaptured;

  const MyMaskProfilePhotoCamera({super.key, required this.onImageCaptured});

  @override
  State<MyMaskProfilePhotoCamera> createState() => _MyMaskCameraState();
}

class _MyMaskCameraState extends State<MyMaskProfilePhotoCamera> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaskForCameraView(
      title: "Place your face inside the rectangle",
