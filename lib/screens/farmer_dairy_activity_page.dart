...
class FarmerDiaryActivityPage extends StatefulWidget {
  const FarmerDiaryActivityPage({
    super.key,
  });

  @override
  State<FarmerDiaryActivityPage> createState() => _FarmerDiaryActivityPageState();
}

class _FarmerDiaryActivityPageState extends State<FarmerDiaryActivityPage> {
