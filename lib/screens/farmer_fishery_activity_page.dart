...
class FarmerFisheryActivityPage extends StatefulWidget {
  const FarmerFisheryActivityPage({super.key,});

  @override
  State<FarmerFisheryActivityPage> createState() =>
      _FarmerFisheryActivityPageState();
}

class _FarmerFisheryActivityPageState extends State<FarmerFisheryActivityPage> {
